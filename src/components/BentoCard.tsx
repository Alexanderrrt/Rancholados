...
export default function BentoCard({ item, isHero = false }: Props) {
  ...
  if (isHero) {
    return (
      <div className="bento-card relative group col-span-2 row-span-2 bg-chocolate-dark shadow-xl cursor-pointer">
        {item.image && (
          <Image
            src={item.image}
            alt={name}
          ...
          <div className="flex items-center gap-4">
            ...
            {item.isAvailable && (
              <a
                ...
                className="inline-flex items-center gap-1.5 px-5 py-2.5 rounded-3xl font-body font-bold text-sm bg-[#25D366] text-white hover:bg-[#1da851] hover:scale-105 active:scale-95 transition-all duration-200 shadow-lg"
              >
  ...
  return (
    <div className="bento-card relative group bg-blanco shadow-[0_4px_20px_rgba(61,35,20,0.08)] cursor-pointer">
      {/* Category color strip */}
      <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-rosa-fuerte to-arequipe z-20 rounded-t-2xl" />
          ...
          <div className="flex items-center justify-between">
            ...
            {item.isAvailable && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1 px-3 py-1.5 rounded-2xl font-body font-bold text-xs bg-[#25D366] text-white hover:bg-[#1da851] transition-colors"
