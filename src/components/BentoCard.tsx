...
export default function BentoCard({ item, isHero = false }: Props) {
          ...
          <div className="flex items-center gap-4">
            ...
            {item.isAvailable && (
              <a
                ...
                className="btn-shine inline-flex items-center gap-1.5 px-5 py-2.5 rounded-full font-body font-extrabold text-sm bg-[#25D366] text-white hover:bg-[#1da851] shadow-lg"
              >
  ...
  return (
    <div className="bento-card card-accent relative group bg-blanco shadow-[0_4px_20px_rgba(61,35,20,0.08)] cursor-pointer border border-chocolate/10">
          ...
          <div className="flex items-center justify-between">
            ...
            {item.isAvailable && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="btn-shine inline-flex items-center gap-1 px-3 py-1.5 rounded-full font-body font-extrabold text-xs bg-[#25D366] text-white hover:bg-[#1da851] transition-colors"
