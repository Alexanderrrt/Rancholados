        ...
        <div className="hidden md:flex items-center gap-6">
          {links.map((link) => (
            <Link
              key={link.href}
              href={link.href}
              className={`font-body font-semibold text-sm transition-colors hover:text-rosa-fuerte ${
                pathname === link.href
                  ? "text-rosa-fuerte"
                  : "text-chocolate/70"
              }`}
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 bg-[#25D366] text-white font-body font-bold px-4 py-2 rounded-3xl text-sm hover:bg-[#1da851] transition-colors"
          >
        ...
        <div className="md:hidden bg-blanco border-t border-rosa-claro animate-fade-up">
          <div className="px-4 py-4 flex flex-col gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-[#25D366] text-white font-body font-bold px-5 py-2.5 rounded-3xl text-base hover:bg-[#1da851] transition-colors w-fit"
            >
