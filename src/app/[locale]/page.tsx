...
export default function HomePage() {
  ...
  return (
    <>
      {/* Hero Section */}
      <ParallaxHero>
        <div className="max-w-6xl mx-auto px-4 py-16 md:py-24 flex flex-col md:flex-row items-center gap-8 md:gap-12 relative z-10">
          {/* Text */}
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <Link
                href="/menu"
                className="bg-rosa-fuerte text-white font-body font-bold px-8 py-3 rounded-3xl text-lg hover:bg-rosa-hover hover:scale-105 active:scale-95 transition-all duration-200 shadow-lg shadow-rosa-fuerte/20 text-center"
              >
                {t("hero.cta")}
              </Link>
              <a
                ...
                className="inline-flex items-center justify-center gap-2 bg-[#25D366] text-white font-body font-bold px-8 py-3 rounded-3xl text-lg hover:bg-[#1da851] hover:scale-105 active:scale-95 transition-all duration-200 shadow-lg shadow-[#25D366]/20 text-center"
              >
      ...
      <section className="max-w-6xl mx-auto px-4 py-16">
        ...
        <ScrollReveal animation="fade-up" delay={400}>
          <div className="text-center mt-10">
            <Link
              href="/menu"
              className="inline-block bg-rosa-claro text-rosa-fuerte font-body font-bold px-8 py-3 rounded-3xl text-lg hover:bg-rosa-fuerte hover:text-white hover:scale-105 active:scale-95 transition-all duration-200"
            >
              {t("menu.viewFull")} →
            </Link>
          </div>
      ...
      <section className="bg-rosa-claro">
        <div className="max-w-6xl mx-auto px-4 py-16 text-center">
          ...
          <ScrollReveal animation="zoom-in" delay={300}>
            <Link
              href="/about"
              className="inline-block bg-chocolate text-crema font-body font-bold px-8 py-3 rounded-3xl text-lg hover:bg-chocolate/80 hover:scale-105 active:scale-95 transition-all duration-200"
            >
              {t("about.title")} →
            </Link>
          </ScrollReveal>
