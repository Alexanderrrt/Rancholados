        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 md:py-16 lg:py-20">
          <div className="max-w-2xl pt-4 md:pt-8 pb-10 md:pb-14">
            ...
            <ScrollReveal animation="fade-up" delay={100}>
              <h1 className="font-heading text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-extrabold text-chocolate leading-[0.9] mb-5">
                Rancholados
              </h1>
            </ScrollReveal>
            ...
            <ScrollReveal animation="fade-up" delay={200}>
              <p className="font-heading text-2xl sm:text-3xl md:text-4xl font-extrabold text-rosa-fuerte leading-tight text-balance mb-4">
                {isEs
                  ? "Cholados, helados caseros y fruta fresca"
                  : "Cholados, homemade ice cream and fresh fruit"}
              </p>
            </ScrollReveal>
            ...
            <ScrollReveal animation="fade-up" delay={350}>
              <div className="flex flex-col sm:flex-row gap-3">
                <Link
                  href="/menu"
                  className="inline-flex items-center justify-center bg-rosa-fuerte text-white font-body font-extrabold px-7 py-3.5 rounded-lg text-base sm:text-lg hover:bg-rosa-hover active:scale-[0.98] transition-all duration-200 shadow-lg shadow-rosa-fuerte/20"
                >
                  {t("hero.cta")}
                </Link>
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-[#25D366] text-white font-body font-extrabold px-7 py-3.5 rounded-lg text-base sm:text-lg hover:bg-[#1da851] active:scale-[0.98] transition-all duration-200 shadow-lg shadow-[#25D366]/20"
                >
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 py-16 md:py-24">
          <ScrollReveal animation="fade-up">
            <div className="text-center mb-10">
              <p className="font-body text-rosa-fuerte text-sm tracking-[0.2em] uppercase mb-3">
                {isEs ? "Lo mejor de la casa" : "House favorites"}
              </p>
          ...
          <ScrollReveal animation="fade-up" delay={300}>
            <div className="text-center mt-10">
              <Link
                href="/menu"
                className="inline-flex items-center justify-center bg-chocolate text-crema font-body font-extrabold px-7 py-3 rounded-lg text-base hover:bg-chocolate-light active:scale-[0.98] transition-all duration-200 shadow-lg shadow-chocolate/15"
              >
                {t("menu.viewFull")}
              </Link>
            </div>
            ...
            <ScrollReveal animation="fade-up">
              <div>
                <p className="font-body text-verde-cali text-sm tracking-[0.2em] uppercase mb-3">
                  {isEs ? "Visitanos" : "Visit us"}
                </p>
                <h2 className="font-heading text-3xl md:text-5xl font-extrabold leading-tight text-chocolate mb-4">
                  {t("location.title")}
                </h2>
                <p className="font-body text-lg text-chocolate/65 mb-8 text-balance">
                  {t("location.subtitle")}
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center bg-rosa-fuerte text-white font-body font-extrabold px-6 py-3 rounded-lg text-sm hover:bg-rosa-hover active:scale-[0.98] transition-all duration-200"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center bg-blanco text-chocolate font-body font-extrabold px-6 py-3 rounded-lg text-sm border border-chocolate/10 hover:border-rosa-fuerte/30 hover:text-rosa-fuerte active:scale-[0.98] transition-all duration-200"
                  >
                    Instagram
                  </a>
                </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <ScrollReveal animation="fade-up">
            <div className="text-center mb-8">
              <p className="font-body text-rosa-fuerte text-sm tracking-[0.2em] uppercase mb-3">
                {isEs ? "Menu rapido" : "Quick menu"}
              </p>
              <h3 className="font-heading text-2xl md:text-3xl font-extrabold text-chocolate">
                {isEs ? "Explora por categoria" : "Explore by category"}
              </h3>
            </div>
          </ScrollReveal>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
              {categories.map((cat) => (
                <Link
                  key={cat.id}
                  href={`/menu#${cat.slug}`}
                  className="group relative min-h-[150px] overflow-hidden rounded-lg bg-chocolate shadow-sm"
                >
                  {cat.image ? (
                    <Image
                      src={cat.image}
