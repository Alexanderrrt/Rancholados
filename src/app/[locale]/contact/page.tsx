    ...
    <>
      <section className="relative overflow-hidden bg-crema border-b border-chocolate/10">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 py-12 md:py-16">
          <p className="sec-eyebrow font-body mb-3" data-num="01">
            Tully Road
          </p>
        ...
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-[0.95fr_1.05fr] gap-8 items-stretch">
          <div className="space-y-4">
            {detailCards.map((card) => (
              <div
                key={card.label}
                className="card-interactive card-accent overflow-hidden rounded-lg border border-chocolate/10 bg-blanco p-5 shadow-[0_4px_20px_rgba(61,35,20,0.07)]"
              >
            ...
            <div className="rounded-lg bg-rosa-claro/70 p-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <a
                  ...
                  className="btn-shine inline-flex items-center justify-center bg-rosa-fuerte text-white font-body font-extrabold px-5 py-3 rounded-full text-sm hover:bg-rosa-hover transition-colors"
                >
                  {t("getDirections")}
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn-shine inline-flex items-center justify-center bg-[#25D366] text-white font-body font-extrabold px-5 py-3 rounded-full text-sm hover:bg-[#1da851] transition-colors"
                >
                  {t("orderWhatsApp")}
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn-shine inline-flex items-center justify-center bg-blanco text-chocolate font-body font-extrabold px-5 py-3 rounded-full text-sm hover:text-rosa-fuerte transition-colors"
                >
                  {t("followUs")}
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn-shine inline-flex items-center justify-center bg-chocolate text-crema font-body font-extrabold px-5 py-3 rounded-full text-sm hover:bg-chocolate-light transition-colors"
                >
                  {t("orderDelivery")}
                </a>
              </div>
